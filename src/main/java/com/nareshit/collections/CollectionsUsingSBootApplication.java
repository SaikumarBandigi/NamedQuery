...
///////////////////////////////////
    ...
    private void retireveBookById() {

        Iterable<Book> bookObj = personService.retireveBookById(25);
    ...
    private void getAllPersons() {
        Iterable<Person> personsList = personService.getAllPersons();
        for (Person person : personsList) {
            System.out.println("Person Object" + person.toString());
        }
    ...
    private void findByLastNameAndFirstName() {
        ...
        Person personObj = personService.findByLastNameAndFirstName("Kumar", "Sita");
    ...
    private void giveFewcolumns() {
        ...
        Iterable<Person> personsList = personService.giveFewcolumns("kumar");
        for (Person person : personsList) {
            System.out.println("Person Object" + person.toString());
